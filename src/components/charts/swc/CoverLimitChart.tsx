...
import { formatNumber, formatBigNumber, tooltipFormatterNumber, tooltipFormatterBigNumber, tooltipLabelFormatterTime, range, formatTimestamp, leftPad, calculateWeeklyTicks, xtickLabelFormatter } from "./../../../helpers/index"
...
const CoverLimitChart: any = (props: any) => {
  ...
  return (
    ...
    >
      ...
      <Line type="monotone" dataKey="sum.coverLimit" stroke="#000000" dot={false} strokeWidth={1}/>
    </LineChart>
  )

}

export default CoverLimitChart

function joinHistories(histories: any) {
  var history: any = []
  var keys = Object.keys(histories)
  var datakeys = ["coverLimit"]
