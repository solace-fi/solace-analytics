...
import { formatNumber, formatBigNumber, tooltipFormatterNumber, tooltipFormatterBigNumber, tooltipLabelFormatterTime, range, rangeBN, formatTimestamp, leftPad, calculateWeeklyTicks, xtickLabelFormatter, sortBNs } from "./../../../helpers/index"
...
const PremiumsChart: any = (props: any) => {
  ...
  return (
    ...
    >
      ...
      <Line type="monotone" dataKey="sum.depositsMade" stroke="#ff0000" dot={false} strokeWidth={1}/>
      <Line type="monotone" dataKey="sum.premiumsCharged" stroke="#00ff00" dot={false} strokeWidth={1}/>
      <Line type="monotone" dataKey="sum.rewardPointsEarned" stroke="#0000ff" dot={false} strokeWidth={1}/>
    </LineChart>
  )
