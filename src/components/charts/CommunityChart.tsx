...
import { formatNumber, tooltipFormatterNumber, tooltipLabelFormatterTime, range, calculateWeeklyTicks, xtickLabelFormatter } from "./../../helpers/index"
...
const CommunityChart: any = (props: any) => {
  ...
  return (
    ...
    >
      ...
      <Line type="monotone" dataKey="Twitter" stroke="#34aaf3" dot={false} strokeWidth={1}/>
      <Line type="monotone" dataKey="Discord" stroke="#6543ec" dot={false} strokeWidth={1}/>
    </LineChart>
  )
}
